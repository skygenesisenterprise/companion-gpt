...
Thank you for using **AI Modal** — the official company website developed and maintained by [Sky Genesis Enterprise](https://skygenesisenterprise.com).
...
- 💬 [GitHub Discussions](https://github.com/skygenesisenterprise/companion-gpt/discussions)
- 🐞 [GitHub Issues](https://github.com/skygenesisenterprise/companion-gpt/issues) – for bug reports only
...
Want to help improve for the AI Modal?  
